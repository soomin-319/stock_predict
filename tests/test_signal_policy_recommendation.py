...
def test_recommendation_ignores_signal_probability_and_uncertainty_for_decision():
    ...
    assert recommendation_from_signal(0.9, -1.9, up_probability=0.9, uncertainty_score=0.1) == "관망"
