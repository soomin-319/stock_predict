...
def test_symbol_name_cache_follows_current_csv_path(monkeypatch, tmp_path: Path):
    default_csv_path = krx_universe.KRX_SYMBOL_NAME_CSV
    csv_path = tmp_path / "krx_symbol_name_map.csv"
    csv_path.write_text(
        "Ticker,Symbol,Name,Market\n005930,005930.KS,삼성전자,KOSPI\n",
        encoding="utf-8",
    ...
    assert krx_universe.get_symbol_name_map(["000660.KS"]) == {"000660.KS": "000660.KS"}
