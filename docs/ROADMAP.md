...
1. Keep recommendation-policy tests fixed around the 2% return thresholds and uncertainty-aware signal overrides.
...
- Tighten issue-summary cache invalidation rules for Kakao/Colab runs.
